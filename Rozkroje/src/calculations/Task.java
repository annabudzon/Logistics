...
public class Task {
    ...
    public Task(double length, double kits_amount, int elements1_amount, int elements2_amount, double price_m){
        this.length = length;
    ...
    public Task(double length, double kits_amount, int elements1_amount, int elements2_amount){
        this.length = length;
        this.kits_amount = kits_amount;
        this.elements1_amount = elements1_amount;
        this.elements2_amount = elements2_amount;
    ...
    public void setKits_amount(double kits_amount) {
        this.kits_amount = kits_amount;
    }
